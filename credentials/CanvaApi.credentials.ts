...
export class CanvaApi implements ICredentialType {
	...
	properties: INodeProperties[] = [
		...
		},
		{
			...
			default: '',
			required: true,
			description: 'Client ID obtenido en el Canva Developer Portal',
			hint: 'Asegúrate de habilitar todos los scopes necesarios en tu integración',
		},
		{
			...
			default: '',
			required: true,
			description: 'Client Secret generado en el Canva Developer Portal',
		},
		{
			displayName: 'Scope',
			name: 'scope',
